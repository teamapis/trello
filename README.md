...
> The Trello API schema over time.

![Trello](assets/trello-logo-gradient-blue-attribution_rgb@2x.png)

The Atlassian Trello API documentation is located [here](https://developer.atlassian.com/cloud/trello/rest/api-group-actions/) on the Atlassian Developer website.
